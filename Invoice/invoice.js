...
export const createInvoiceTemplate = (invoice) => {
   const today = new Date()
   const { fullName, invoiceId, address, orderItems } = invoice;
   return `
    <!doctype html>
    <html>
       <head>
       ...
       <body>
          <div class="invoice-box">
             ...
             <br />
             <h3 class="justify-center">Total price: ${orderItems.reduce((total, item) => total + parseInt(item.price), 0)}$</h3>
             <footer>
